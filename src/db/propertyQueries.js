// Week 3 deliverable: parameterized query layer for rets_property and california_sold.
...
async function searchActiveListings(filters, page = 1, limit = 10) {
...
async function getSoldComps(city, months = 12) {
  const sql = `
    SELECT
...
module.exports = { query, searchActiveListings, getSoldComps };